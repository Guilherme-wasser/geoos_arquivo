...
def velocidade_agua():
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            nome2 = "Babitonga15"
            nome3 = "U"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/Babitonga/Hydrodynamic_2_Surface.nc":uo /home/data/UFPR/Babitonga/{}_{}.nc'.format(nome2,nome3)
            ...
            for banda in range(1, bandas+1):
                ...
                nc_file_path = '/home/data/UFPR/CEP/tmp/{}.nc'.format(nome)
