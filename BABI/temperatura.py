...
def temperatura():
    ...
    def achar_hora():
            ds = xr.open_dataset('/opt/geoos/data/UFPR/Babitonga/WaterProperties_2_Surface.nc')
            dt = ds['time'].values
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            host_directory = '/opt/geoos/data/UFPR/Babitonga/tmp/'
            ...
            nome2 = "Babitonga1"
            nome3 = "temperatura"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/Babitonga/WaterProperties_2_Surface.nc":temperature /home/data/UFPR/Babitonga/{}_{}.nc'.format(nome2,nome3)
            ...
            for banda in range(1, bandas+1):
                ...
                command2 = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/Babitonga/{}_{}.nc":{} /home/data/UFPR/Babitonga/tmp/{}.nc'.format(nome2,nome3, banda_nome, nome)
                nc_file_path = '/home/data/UFPR/Babitonga/tmp/{}.nc'.format(nome)
