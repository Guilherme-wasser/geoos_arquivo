...
def salinidade():
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            nome2 = "Babitonga1"
            nome3 = "salinidade"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/Babitonga/WaterProperties_2_Surface.nc":salinity /home/data/UFPR/Babitonga/{}_{}.nc'.format(nome2,nome3)
