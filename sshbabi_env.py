...
def altura_da_superficie_agua_babitonga():

    #função para buscar a hora dentro do arquivo a ser tratado
    def achar_hora():
            ds = xr.open_dataset('/opt/geoos/data/cabral/Hydrodynamic_2_Surface.hdf5.nc')
            dt = ds['time'].values
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            host_directory = '/opt/geoos/data/brasil/'
            ...
            nome3 = "sshbabitonga"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/cabral/Hydrodynamic_2_Surface.hdf5.nc":ssh /home/data/cabral/{}.nc'.format(nome3)
            ...
            for banda in range(1, bandas+1):
                ...
                nome = "{}_{}".format(nome3, data_variada_formatada)
                banda_nome = 'Band{}'.format(banda)
                command2 = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/cabral/{}.nc":{} /home/data/brasil/{}.nc'.format(nome3, banda_nome, nome)
                nc_file_path = '/home/data/brasil/{}.nc'.format(nome)
...
altura_da_superficie_agua_babitonga()
