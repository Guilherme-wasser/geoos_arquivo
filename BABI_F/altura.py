...
def altura():
    ...
    def achar_hora():
            ds = xr.open_dataset('/opt/geoos/data/UFPR/Babitonga/Hydrodynamic_2_Surface.nc')
            dt = ds['time'].values
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            nome2 = "Babitonga15"
            nome3 = "altura"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/Babitonga/Hydrodynamic_2_Surface.nc":zos /home/data/UFPR/Babitonga/{}_{}.nc'.format(nome2,nome3)
