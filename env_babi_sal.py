...
def salinidade_babitonga():
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            nome1 = "sbabitonga"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/cabral/WaterProperties_2_Surface.hdf5.nc":salinity /home/data/cabral/{}.nc'.format(nome1)
            ...
            for banda in range(1, bandas+1):
                ...
                nome = "{}_{}".format(nome1, data_variada_formatada)
                banda_nome = 'Band{}'.format(banda)
                command2 = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/cabral/{}.nc":{} /home/data/brasil/{}.nc'.format(nome1, banda_nome, nome)
