...
def velocidade_agua_babitonga():
    ...
    def achar_hora():
            ds = xr.open_dataset('/opt/geoos/data/UFPR/S_SE/Hydrodynamic_2_Surface.nc')
            dt = ds['time'].values
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            host_directory = '/opt/geoos/data/UFPR/S_SE/tmp/'
            ...
            nome2 = "SUDESTE15"
            nome3 = "U"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/S_SE/Hydrodynamic_2_Surface.nc":uo /home/data/UFPR/S_SE/{}_{}.nc'.format(nome2,nome3)
            ...
            for banda in range(1, bandas+1):
                ...
                command2 = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/S_SE/{}_{}.nc":{} /home/data/UFPR/S_SE/tmp/{}.nc'.format(nome2,nome3, banda_nome, nome)
                nc_file_path = '/home/data/UFPR/S_SE/tmp/{}.nc'.format(nome)
