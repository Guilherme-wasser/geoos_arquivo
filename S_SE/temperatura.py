...
def temperatura():
    ...
    def achar_hora():
            ds = xr.open_dataset('/opt/geoos/data/UFPR/S_SE/WaterProperties_2_Surface.nc')
            dt = ds['time'].values
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            nome2 = "SUDESTE1"
            nome3 = "temperatura"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/S_SE/WaterProperties_2_Surface.nc":temperature /home/data/UFPR/S_SE/{}_{}.nc'.format(nome2,nome3)
