...
def temperatura_babitonga():

    #função para buscar a hora dentro do arquivo a ser tratado
    def achar_hora():
            ds = xr.open_dataset('/opt/geoos/data/cabral/WaterProperties_2_Surface.hdf5.nc')
            dt = ds['time'].values
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            nome0 = "tbabitonga"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/cabral/WaterProperties_2_Surface.hdf5.nc":temperature /home/data/cabral/{}.nc'.format(nome0)
            ...
            for banda in range(1, bandas+1):
                ...
                nome = "{}_{}".format(nome0, data_variada_formatada)
                banda_nome = 'Band{}'.format(banda)
                command2 = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/cabral/{}.nc":{} /home/data/brasil/{}.nc'.format(nome0, banda_nome, nome)
