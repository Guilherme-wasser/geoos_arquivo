...
def velocidade_agua():
    ...
    def achar_hora():
            ds = xr.open_dataset('/opt/geoos/data/UFPR/NORTE/Hydrodynamic_2_Surface.nc')
            dt = ds['time'].values
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            nome2 = "AMPA15"
            nome3 = "U"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/NORTE/Hydrodynamic_2_Surface.nc":uo /home/data/UFPR/NORTE/{}_{}.nc'.format(nome2,nome3)
