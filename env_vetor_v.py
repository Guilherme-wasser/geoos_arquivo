...
def velocidade_agua_babitonga():
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            nome2 = "vetor"
            nome3 = "V"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/cabral/Hydrodynamic_2_Surface.hdf5.nc":v /home/data/cabral/{}_{}.nc'.format(nome2,nome3)
            ...
            for banda in range(1, bandas+1):
                ...
                command2 = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/cabral/{}_{}.nc":{} /home/data/brasil/{}.nc'.format(nome2,nome3, banda_nome, nome)
