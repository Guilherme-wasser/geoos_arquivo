...
def velocidade_agua_babitonga():
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            nome2 = "vmbabitonga"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/cabral/Hydrodynamic_2_Surface.hdf5.nc":vm /home/data/cabral/{}.nc'.format(nome2)
            ...
            for banda in range(1, bandas+1):
                ...
                nome = "{}_{}".format(nome2, data_variada_formatada)
                banda_nome = 'Band{}'.format(banda)
                command2 = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/cabral/{}.nc":{} /home/data/brasil/{}.nc'.format(nome2, banda_nome, nome)
