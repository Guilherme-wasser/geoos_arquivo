...
def temperatura():
    ...
    def achar_hora():
            ds = xr.open_dataset('/opt/geoos/data/UFPR/FPOLIS/WaterProperties_2_Surface.nc')
            dt = ds['time'].values
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            host_directory = '/opt/geoos/data/UFPR/FPOLIS/tmp/'
            ...
            nome2 = "FPOLIS1"
            nome3 = "temperatura"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/FPOLIS/WaterProperties_2_Surface.nc":temperature /home/data/UFPR/FPOLIS/{}_{}.nc'.format(nome2,nome3)
            ...
            for banda in range(1, bandas+1):
                ...
                command2 = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/FPOLIS/{}_{}.nc":{} /home/data/UFPR/FPOLIS/tmp/{}.nc'.format(nome2,nome3, banda_nome, nome)
                nc_file_path = '/home/data/UFPR/FPOLIS/tmp/{}.nc'.format(nome)
