...
scripts_para_executar = ["download.py", "transf.py", "transf2.py", "SCPRSP_V.py", "SCPRSP_U.py", "altura.py","temperatura.py", "salinidade.py", "excluir.py"]

# Definir o caminho onde os scripts estão localizados
caminho_dos_scripts = "/opt/geoos/SCPRSP_F/"
