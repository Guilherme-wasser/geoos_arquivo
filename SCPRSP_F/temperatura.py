...
def temperatura():
    ...
    def achar_hora():
            ds = xr.open_dataset('/opt/geoos/data/UFPR/SCPRSP/WaterProperties_2_Surface.nc')
            dt = ds['time'].values
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            nome2 = "SCPRSP1"
            nome3 = "temperatura"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/SCPRSP/WaterProperties_2_Surface.nc":temperature /home/data/UFPR/SCPRSP/{}_{}.nc'.format(nome2,nome3)
