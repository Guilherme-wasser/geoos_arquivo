...
def velocidade_agua():
    ...
    def processo_gerar_arquivos_com_nomes():
            ...
            host_directory = '/opt/geoos/data/UFPR/CEP/tmp/'
            ...
            nome2 = "FPOLIS15"
            nome3 = "V"
            command = 'gdalwarp -t_srs EPSG:4326 NETCDF:"/home/data/UFPR/FPOLIS/Hydrodynamic_2_Surface.nc":vo /home/data/UFPR/FPOLIS/{}_{}.nc'.format(nome2,nome3)
